...
export default function FunFact({ children }: { children: any }) {
  ...
  return (
    <div className="bg-gray-100 rounded-2xl p-4 my-4">
      <div className="text-xl text-green-700 font-semibold">💡 Fun Fact</div>
      ...
      <div className="flex items-center gap-4 text-gray-500 text-xl">
        ...
        <button
          onClick={() => onClick(0)}
          className={
            selection === 0 ? "border border-green-500 rounded-xl p-1" : "p-1"
          }
        >
          😁
        </button>
        <button
          onClick={() => onClick(1)}
          className={
            selection === 1 ? "border border-red-500 rounded-xl p-1" : "p-1"
          }
        >
          😔
        </button>
